...
data = {
  "messages" => [{"role" => "system", "content" => " Peux-tu me donner une liste de cinq parfums de glace qui sont généralement appréciés ? Merci de les énumérer avec un tiret devant chaque parfum."}],
  "max_tokens" => 50,
  "temperature" => 0.5,
  "model" => "gpt-3.5-turbo"
}
